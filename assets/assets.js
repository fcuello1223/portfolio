...
export const serviceData = [
  {
    ...
    title: "Frontend",
    description: "UI/UX development for superb user experience!",
    link: "",
  },
  {
  ...
  {
    icon: assets.databaseStorage,
    title: "Database Management",
    description:
      "Appropriate Database management for efficient and secure storage of all app-related data",
    link: "",
  },
  {
    icon: assets.cybersecurity,
    title: "Security",
    description: "Ensure Appropriate Security Measures For Applications",
    link: "",
  },
];
